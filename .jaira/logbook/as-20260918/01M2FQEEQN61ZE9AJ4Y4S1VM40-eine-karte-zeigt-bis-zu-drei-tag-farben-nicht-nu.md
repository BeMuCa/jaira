...
related: []
commits:
  - 8fdabc94a9373603de2b05182182eb9cd31c0cd8
  - 1276d7b53f480533fa0065dd7218fdaf5da8fcc5
  - 2fc0140058fe30cf9cc5326203207e8f4cd3eef6
  - db0f0daf12d59513d61ab2ddedd81f6d02097e93
  - f2b0077d6d4369f9a9f3513dc93aa32e30dfb5ca
  - 4e96b33f3eb8b99ad8d468fd2f0dfed785bcc88b
  - e07302570f9971aad21fa06d394e78b00bc53aeb
  - 392690ae7be678e3f0418b4ceac9d1adbe86db6f
  - 209ada8a9bcbfbb437673bd838acf5747e8030b1
  - daf431266556c7d3b1b5ed7f4051b0621e2921a2
  - 5e9bf2e9f16a532697f2ce321fb77bc264c0693c
  - 50f15a294c494ae9ef061f5c2aa9c682d2c5e67a
  - 53f7388e1502fcb65fd83f3eeff8bf02cfca140a
  - 82c111e79ed7ff20d323f0212efa9fa73e6832ae
  - 0dde06a31762e619d597464b759aa98b38681bd1
  - 7b4b7349e70089e6b2c2d3c968acb2694cf9b2a3
  - 2a85eb980d93ad55a8ff5c93c1f8867d535af9d7
  - 86bb3a8e1319fdba152646dd2bd2aba0ad47bdd0
  - f7746a1b95114da22e5c40394a1ecc9ad35926a4
  - 34e3687914f454e4ae83ebd22bed0fbeae905be5
  - 954fdae036a8271583cb1c3c0d97d2e330bbc3fe
  - 3518a44a86d9c0d830f61a24f2e4b865181763c2
  - 814eda22be6c6e8f337ece5238518dac734f9651
...
review-summary: "Die linke Randspalte einer Karte faerbt jetzt drei Zellen statt einer. cardColors (internal/tui/model.go:1359) laeuft ueber die ersten drei Tags des Tickets - die Schleifengrenze ging von cardSlots-1 auf cardSlots - und legt je Tag eine Registry-Farbe in einen Slot; renderCardBlock (internal/tui/view.go:547) malt je Kartenzeile eine Balkenzelle und liest ihre Farbe aus dem Slot dieser Zeile. Damit traegt Zeile 1 die Farbe des ersten, Zeile 2 des zweiten, Zeile 3 des dritten Tags, in Ticket-Reihenfolge. Der frueher fuer die Sprint-Markierung reservierte dritte Platz ist frei geworden, weil die Sprint-Markierung als eigenes Ticket 0YGWXQ an den rechten Kartenrand geht. Ein Slot ohne Tag oder mit einem Tag ohne Zeile in .jaira/tags bleibt ungefaerbt und zeigt die Lane-Schattierung; ein vierter Tag bleibt am Ticket und faerbt nichts - es ist eine reine Anzeigegrenze, jaira tag weist nichts zurueck. Die Karte wird dabei keine Zeile hoeher: cardHeight() (internal/tui/view.go:494) gibt nicht mehr das Literal 3, sondern die Konstante cardSlots zurueck, sodass Zeilenzahl und Slotzahl nicht auseinanderlaufen koennen - genau die beiden Zahlen, deren Auseinanderdriften renderCardBlock an den Slots vorbeiindizieren liesse. Eine Zeile in core/release/NOTES.md (jetzt :22) sagt das dem Benutzer."
review-gaps: "Drei Befunde, keiner am Verhalten - der Code erfuellt die DoD, go test ./... -race ist in diesem Baum gruen (Exit 0, selbst gefahren). Die frueheren Runden habe ich gegen den gemergten Baum nachgeprueft und nicht neu hergeleitet: cardColors laeuft wirklich bis cardSlots, cardHeight gibt wirklich cardSlots zurueck, cardColor hat im ganzen Repo keinen Aufrufer mehr, die sechs Proof-Tests existieren unter den genannten Namen. (1) BEFUND, und er stammt aus genau dieser Runde: Commit 50f15a2 hat goal und das Frontmatter-Feld definition-of-done auf drei Tags umgeschrieben, die losen Prosa-Absaetze im Ticket-Body unter der Checkliste aber stehen gelassen. Zeile 73 sagt dort weiter \"Platz 3 bleibt in diesem Ticket unbelegt und zeigt die Schattierung der Lane\" - das Gegenteil dessen, was ausgeliefert wurde. Das Ticket widerspricht sich damit selbst, und der Ticket-Text ist laut CLAUDE.md das, was in Monaten noch erklaeren soll, was hier gewollt war. Runde 4 hat das mit \"ueber die CLI nicht erreichbar, gehoert in ein eigenes Ticket\" vertagt - ein solches Ticket gibt es auf dem Board nicht (jaira list durchgesehen), die Vertagung laeuft also ins Leere. Entweder Alex streicht die vier Absaetze beim Abnehmen von Hand, oder es wird ein Ticket dafuer angelegt. (2) Klein: die proof-Zeile von DoD-Punkt 6 nennt core/release/NOTES.md:16, die gemeinte Zeile steht nach den Merges auf :22; :16 ist die create --dod-Zeile. (3) Klein: die Abschnittsueberschrift internal/tui/tagbox_test.go:90 heisst weiter \"--- cardColor / cardHeight ---\" und nennt damit eine Funktion, die dieser Diff entfernt hat. NICHT WIEDER AUFGEMACHT: ob drei gestapelte Farbzellen gut lesbar sind - Alex hat sich das echte Board angesehen und es angenommen; das ist entschieden."
