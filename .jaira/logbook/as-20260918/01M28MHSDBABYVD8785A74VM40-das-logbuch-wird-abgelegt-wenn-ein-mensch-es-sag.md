...
blocked-by: []
commits:
  - edb22582f2e3ec8e8f5421dd2c8e83621d6a0b7e
  - 9ad7aa9a1a574bc2be98bb8286f70c6d7bceb68f
  - 14a605719d4aec5598731cc639b44a92c19d26fc
  - 69e2eb5dae93ddcf4973803e27f1485604efaf9b
  - 1570bcbea0d952d0aac572dfd6b6d8edbc30b693
  - 3518a44a86d9c0d830f61a24f2e4b865181763c2
  - 04800146457f708f30faba83f78fd260ee72533d
  - a97626b73f98ddbb21fc6fb7103fa58c22eb2325
  - dd3ec40b1fa068ffc1046fa2ea421270d5e8e1ed
  - c9da99d3652683d485e64460015cc274c21d37b5
  - 912ac3c5ae6ff881f6dd675ce77abd98d421b269
  - 226a54f56447f97660c788d8c80b409f192cb09d
  - 3062f608990ad53dbdc5f64838fc9fae041611ec
  - 1a9efb1d20bcbb52094e070cab4c54644c70af45
  - 78e3703c8158258bc70f776fdbcf2b3eeb1f2c03
  - b178a008caa3b09a9f32b1d18c6cef6ff9390736
  - 0facda1e11581c4a2eb5edceacc7fdf5b2edee25
  - 2c33ce2ac226b9885523d74cdd8d0c8a60d84068
  - 58585236e6206c7d0822f8a27e811cfdbb6b4732
  - 9260cc74e9a8e015d858c80592e2bbf414e4992d
  - 2b4c491becf3485338fb5184405ec2a83cf0c2ea
  - 633c12320a2f9db1b519da0f4a42bf6484bcf09f
  - 343912c4f363c5b2b019ea5c4297892a30fd5fa2
  - 7032a0d59853eb00e31241542232d55887cf1cf8
  - b51dddd18b9fad5dfad0c946c99174c413190146
  - 7ecf9f2c651ba0f1ce05544503fe94fc3b987939
  - 9fdfada5bd7c14927c0c600d46745099ced96d0e
  - f925020813375f0d5ebac3d3e70579850aaf8d16
  - 80b5c5dcd9cbd62dba936d2f561274a17ac0289d
  - 1401da5bcb8c8663710d5b99c2c798200a80c028
created-at: 2026-09-11T16:24:28Z
updated-at: 2026-09-18T07:02:57Z
...
review-check: "1. cd /home/alex/projects/.worktrees/jaira-9ET6NC  2. go test ./... -race  -> the last line is not FAIL and the command exits 0; it takes about four minutes, internal/tui is the slow one  3. go build -o /tmp/jaira74 ./cmd/jaira  -> no output means it built  4. mkdir -p /tmp/board74 && cd /tmp/board74 && git init -q . && /tmp/jaira74 init  -> a fresh board is created  5. grep -c '^logbook-on-entry' /tmp/board74/.jaira/lanes/*done*  -> prints 0; this is the heart of the ticket, a new board has no door that files on its own  6. create three tickets: for i in 1 2 3; do /tmp/jaira74 create \"scratch $i\" --goal g --context c --dod d --assignee me; done  7. move each one to done: for h in $(/tmp/jaira74 list --json | python3 -c \"import json,sys;print(' '.join(t['handle'] for t in json.load(sys.stdin)['tickets']))\"); do /tmp/jaira74 move $h --to done --force --what w --why y --resolves r; done  -> each message says the ticket is done, none says it was filed  8. ls /tmp/board74/.jaira/logbook  -> 'No such file or directory'; finishing filed nothing at all  9. /tmp/jaira74 logbook  -> it lists and files nothing  10. HERE IS THE NEW THING THIS PASS JUDGED: /tmp/jaira74 logbook --all --json  -> every entry under 'filed' has four keys: id, handle, title, file. 'title' is the new one. The three that were there before are still there with the same names and the same values, and 'count' and 'lane' are unchanged, so nothing that read the old output breaks  11. grep -n 'logbook --all --json' /home/alex/projects/.worktrees/jaira-9ET6NC/core/release/NOTES.md  -> the line is found, and the '## Unreleased' heading is above it, not a version number; that is the release note this change owed  12. ls /tmp/board74/.jaira/logbook/*/  -> the three files are in today's dated folder  13. /tmp/jaira74 logbook --all 01ABC  -> refused as a usage error, exit code 2  14. the hint bar: create ten tickets on a fresh board and move them all to done, then run /tmp/jaira74 with no arguments  -> the bottom bar reads '⌸ 10 to file: jaira logbook --all', naming the command and not only the number. Press q to close.  15. the one thing I left open: grep -n 'ReadOnly' /home/alex/projects/.worktrees/jaira-9ET6NC/internal/tui/model.go  -> line 764 repeats the lane rule that core/ticket/trim.go:26 now holds in filesInLane(). Nothing is wrong today; it is two copies of one rule and belongs in a follow-up ticket."
