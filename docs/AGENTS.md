...
commit of its own is one created and handed to someone else — commit it, or
nobody but its author knows it exists. jaira never commits for you — it reads git
and writes only files.
